    ...
    <div class="panel-body">
        <form class="form-horizontal parsley-validate"  action="<?php echo base_url('Usercontroller/showProfile') ?>" method="post">
            ...
            <div class="input-group">
                <input  type="hidden" name="txtIdStudent" class="form-control"  value="<?php echo $this->session->userdata('IDuser'); ?>" >
            </div>
            ...
            <div class="input-group">
				...
				name="txtName" id="txtName" class="form-control"  value="<?php echo $Name; ?>" >
            ...
            <div class="input-group">
                ...
                <input data-parsley-required-message="درج این فیلد اجباری است!"  data-parsley-required="true" type="text" 
				name="txtFamily" id="txtFamily" class="form-control"  value="<?php echo $Lastname; ?>" >
                <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-chevron-right"></span></span>
            </div>
            <br />
            ...
            <div class="input-group">
                ...
                <input data-parsley-required-message="درج این فیلد اجباری است!"  data-parsley-required="true" type="text"
				name="txtUserName" id="txtUserName" class="form-control"  value="<?php echo $this->session->userdata('Username'); ?>" >
			...
			<div class="input-group">
                <span class="input-group-addon">توضیحی کوتاه درباره خود</span>
                <textarea  name="txtAddress" id="txtAddress" class="form-control" ><?php echo $Subject_self; ?></textarea>
                <span class="input-group-addon" id="basic-addon1"><span class="glyphicon glyphicon-send"></span></span>
            </div>
            <br />
