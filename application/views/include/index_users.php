                ...
                <div class="text-center">
                    <div>
                        <div style="margin-top: 8px" id="message">
                            <?php
                            if($this->session->userdata('message_create') != null)
                            {
                                echo '<div class="alert alert-success" role="alert">';
                                echo '<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>';
                                echo	$this->session->userdata('message_create') <> '' ? $this->session->userdata('message_create') : '';
                                echo '</div>';
                                $this->session->unset_userdata('message_create');
                            }
                            ?>
                        </div>
                    </div>
					 ...
					 <div>
						<div class="panel panel-default">
							<div class="panel-heading">
								اطلاعات پروفایل - لطفا تمامی اطلاعات را با دقت و بررسی صحت محتوا تکمیل نمایید!
							</div>
								...
								<input name="userId" id="userId" type="hidden" value="<?php echo $this->session->userdata('IDuser'); ?>" />
									...
									<div class="tab-pane fade" id="messages-pills">
										...
										<div class="form-group input-group">
                                            ...
                                            <textarea name="HealthInfo" placeholder="وضعيت سلامت" class="form-control" cols="200" rows="3">
                                                <?php if(isset($User_info->HealthInfo)) echo $User_info->HealthInfo; ?>
                                            </textarea>
                                        </div>
										<div class="form-group input-group">
                                            <label>من چنین هستم</label>
                                            <textarea name="Iam" data-parsley-required-message="درج این فیلد اجباری است!"  data-parsley-required="true" placeholder="لطفا خالی نگذارید" class="form-control" cols="200" rows="3">
                                                <?php if(isset($User_info->Iam)) echo $User_info->Iam; ?>
                                            </textarea>
                                        </div>
										<div class="form-group input-group">
                                            <label>همسرم چنین باشد</label>
                                            <textarea name="WifeIs" data-parsley-required-message="درج این فیلد اجباری است!"  data-parsley-required="true" placeholder="لطفا خالی نگذارید" class="form-control" cols="200" rows="3">
                                                 <?php if(isset($User_info->WifeIs)) echo $User_info->WifeIs; ?>
                                            </textarea>
                                        </div>
