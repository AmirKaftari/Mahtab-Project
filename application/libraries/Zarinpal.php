...
class Zarinpal
{
    ...
    public function request($merchant_id, $amount, $desc, $call_back, $mobile = null, $email = null)
    {
        ...
        $data = array('MerchantID' => $merchant_id,'Amount'=> $amount,'Description' => $desc,'CallbackURL' => $call_back);
    ...
    public function verify($merchant_id, $amount, $authority)
    {
        ...
        $data = array('MerchantID' => $merchant_id,'Amount' => $amount,'Authority'  => $authority);
